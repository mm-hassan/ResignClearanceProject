<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Tms.aspx.cs" Inherits="ResignClearanceInterview.Tms" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">   
  ...
  <div class="content-wrapper">
    ...
    <section class="content" id="div_EmployeeFeedback" runat="server">
      ...
      <div class="card">
        <div class="card-header" style="background-color:#363940; color:white;">
          <h3 class="card-title">Employee Last Duty Date</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
                   ...
                   <asp:GridView ID="gv_LastDutyDtl" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false" OnRowDataBound="gv_detail_RowDataBound">
                            <Columns>
                                  <asp:TemplateField HeaderText="Block">
                                      <ItemTemplate >
                                          <asp:CheckBox ID="cb_Confirm" runat="server" /> <b>Confirm</b> 
                                      </ItemTemplate>
                                  </asp:TemplateField>
