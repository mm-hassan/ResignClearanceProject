<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="ResignClearanceInterview.Admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">   
  ...
  <div class="content-wrapper">
    ...
    <section class="content" id="div_EmployeeFeedback" runat="server">
      ...
      <div class="card">
        <div class="card-header" style="background-color:#363940; color:white;">
          <h3 class="card-title">Employee Assest Details</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
        ...
        <div class="card-body" id="div_Cardbody" runat="server"> 
            <div class="card">
              <div class="card-body" style="width: 100%; height: auto; overflow: auto;">
                   <asp:GridView ID="gv_GatepassDtl" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false" OnRowDataBound="gv_detail_RowDataBound">
                            <Columns>
                                  <asp:TemplateField HeaderText="Status">
                                      <ItemTemplate >
                                          <asp:CheckBox ID="cb_Collected" runat="server" /> <b>Yes</b> 
                                      </ItemTemplate>
                                  </asp:TemplateField>
                                  <asp:BoundField DataField="HEAD" HeaderText="Head" />
                                  <%--<asp:BoundField DataField="STATUS" HeaderText="Status" />--%>
                                  <asp:BoundField DataField="DESCRIPTION" HeaderText="Descriptions" />
                                  <%--<asp:BoundField DataField="GOING_TO" HeaderText="Going To" />
                                  <asp:BoundField DataField="ITEM_DESCRIPTION" HeaderText="Item Description" />
                                  <asp:BoundField DataField="NEED_BY_DATE" HeaderText="Need by Date" />
                                  <asp:BoundField DataField="GP_ENTRY_USER" HeaderText="Created By" />--%>
                             </Columns>
                   </asp:GridView>
              </div>
            </div>
        ...
        <div class="card-footer">
            ...
            <div class="row">
                <div class="col-8">
                    <asp:Label ID="lbl_GatepassMsg" runat="server" />
                </div>
             <%--   <div class="col-4 text-right">
