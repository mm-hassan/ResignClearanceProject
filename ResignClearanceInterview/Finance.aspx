<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Finance.aspx.cs" Inherits="ResignClearanceInterview.Finance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-wrapper">
                ...
                <div class="card-body p-1">
                    <div class="card">
                        <div class="card-body p-0" style="width: 100%; height: 300px; overflow: auto;">
                            <asp:GridView ID="gv_PendingRequests" runat="server" PagerStyle-CssClass="gridview-pager" AllowPaging="false" OnPageIndexChanging="gv_PendingRequests_PageIndexChanging" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="REG_CD" HeaderText="Region" />
                                ...
                                <div class="card-body pt-0">
                                    <div class="row">
                                        ...
                                        <div class="col-8 col-md-5">
                                            ...
                                            <span runat="server" id="lbl_EmployeeCode" style="display: none;"></span>
                                            <h2 class="lead" runat="server" id="lbl_EmployeeName" style="color: #5960ff; font-weight: 900; text-decoration: underline;"><b>Employee Name</b></h2>
                                            <p style="display: none;" runat="server" id="lbl_Designation">Designation</p>
                                            <p style="display: none;" runat="server" id="lbl_Department">Department</p>
        ...
        <!-- Main content Request type start------------------------------------------------------------------------->
        <section class="content" id="div_EmployeeFeedback" runat="server" style="display: none;">

            <div class="card">
                <div class="card-header" style="background-color: #363940; color: white;">
                    <h3 class="card-title">Employee Outstanding Details</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                ...
                <div class="card-body" id="div_Cardbody" runat="server">
                    <div class="card">
                        <div class="card-body" style="width: 100%; height: auto; overflow: auto;">
                            <asp:GridView ID="gv_LastDutyDtl" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false" OnRowDataBound="gv_detail_RowDataBound">
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="LAST_DUTY" HeaderText="Last Duty Date" />
                                </Columns>
                            </asp:GridView>
                        </div>
                    </div>
