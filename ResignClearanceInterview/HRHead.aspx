<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="HRHead.aspx.cs" Inherits="ResignClearanceInterview.HRHead" %>
                   ...
                   <asp:GridView ID="gv_PendingRequests" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false">
                              <Columns>
                                  <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                           <asp:LinkButton ID="lbl_View" runat="server"  CssClass="btn btn-outline-dark"  CommandName="View" CommandArgument='<%# Bind("REQUEST_EMP_ID") %>' OnClick="lbl_View_Click">View</asp:LinkButton>
                                        </ItemTemplate>
                                  </asp:TemplateField>
                                ...
                                <div class="touchspin-inner pt-1 text-right">
                                    ...
                                    <asp:LinkButton ID="btn_Reject" runat="server" class="btn btn-sm bg-teal" OnClick="btn_Reject_Click" style="background-color: #363940!important;">
                                     <i class="fas fa-user"></i> Reject</asp:LinkButton>
                                        Waive off <asp:CheckBox ID="cb_Waiveoff" CssClass="ckbox" runat="server" />
