<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="BT.aspx.cs" Inherits="ResignClearanceInterview.BT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">   
  ...
  <div class="content-wrapper">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-8 col-md-5">
                      ...
                      <p runat="server" id="lbl_Designation" style="display:none;">Designation</p> <p runat="server" style="display:none;" id="lbl_Department">Department</p>
    ...
    <section class="content" id="div_EmployeeFeedback" runat="server">
      ...
      <div class="card">
        <div class="card-header" style="background-color:#363940; color:white;">
          <h3 class="card-title">Employee Communication Details</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
        ...
        <div class="card-body" id="div_Cardbody" runat="server"> 
            <div class="card">
              <div class="card-body" style="width: 100%; height: auto; overflow: auto;">
                   <asp:GridView ID="gv_CommunicationDtl" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false" OnRowDataBound="gv_detail_RowDataBound">
                            <Columns>
                                  <asp:TemplateField HeaderText="Block">
                                      <ItemTemplate >
                                          <asp:CheckBox ID="cb_Block" runat="server" /> <b>Block</b> 
                                      </ItemTemplate>
                                  </asp:TemplateField>
                                  <asp:BoundField DataField="TRANS_ID" HeaderText="Transaction ID" />
                                  <asp:BoundField DataField="CATGRY" HeaderText="Item Category" />
                                  <asp:BoundField DataField="BRAND" HeaderText="Brand Name" />
                                  <asp:BoundField DataField="SIM_NUMBER" HeaderText="Sim Number" />
        ...
        <div class="card-footer">
            ...
            <div class="row">
                <div class="col-8">
                    <asp:Label ID="lbl_CommunicationMsg" runat="server" />
                </div>
             <%--   <div class="col-4 text-right">
