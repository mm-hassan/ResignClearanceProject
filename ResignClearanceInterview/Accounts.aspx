<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Accounts.aspx.cs" Inherits="ResignClearanceInterview.Accounts" %>
        ...
        <div class="card-body" id="div_Cardbody" runat="server"> 
            <div class="card">
              <div class="card-body" style="width: 100%; height: auto; overflow: auto;">
                   <asp:GridView ID="gv_CardsCollections" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false" OnRowDataBound="gv_detail_RowDataBound">
                            <Columns>
                                  <%--<asp:TemplateField HeaderText="Collected">
                                      <ItemTemplate >
                                          <asp:CheckBox ID="cb_Collected" runat="server" /> <b>Received</b> 
                                      </ItemTemplate>
                                  </asp:TemplateField>--%>
                                  <asp:BoundField DataField="HEAD" HeaderText="Head Description" />
                                  <asp:BoundField DataField="TRANSACTION_DATE" HeaderText="Last Deduction Date" />
                                  <asp:BoundField DataField="AMOUNT" HeaderText="Remaining Amount" />
                             </Columns>
                   </asp:GridView>
              </div>
            </div>
