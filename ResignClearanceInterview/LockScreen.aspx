<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LockScreen.aspx.cs" Inherits="ResignClearanceInterview.LockScreen" %>
...
<div class="lockscreen-wrapper shadow-lg p-4 rounded">
  ...
  <!-- User name -->
  <div class="lockscreen-name">Online Clearance Portal</div><br /><br /><br />
