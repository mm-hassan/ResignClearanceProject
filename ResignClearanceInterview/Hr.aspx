<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Hr.aspx.cs" Inherits="ResignClearanceInterview.Hr" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">   
  ...
  <div class="content-wrapper">
    ...
    <section class="content" id="div_EmployeeFeedback" runat="server">
      ...
      <div class="card">
        <div class="card-header" style="background-color:#363940; color:white;">
          <h3 class="card-title">Cards Collection</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
              ...
              <div class="card-body" style="width: 100%; height: auto; overflow: auto;">
                   <asp:GridView ID="gv_CardsCollections" runat="server" CssClass="table table-bordered table-striped" Font-Size="13px" AutoGenerateColumns="false" OnRowDataBound="gv_detail_RowDataBound">
                            <Columns>
                                  ...
                                  <asp:BoundField DataField="TYPE_NAME" HeaderText="Cards Types" />
                             </Columns>
                   </asp:GridView>
              </div>
            </div>
