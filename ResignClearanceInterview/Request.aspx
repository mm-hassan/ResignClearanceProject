<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Request.aspx.cs" Inherits="ResignClearanceInterview.Request" %>
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-8 col-md-5">
                      ...
                      <h2 class="lead text-right p-0 m-0" runat="server" id="ss"><b>MANAGER : </b> <span runat="server" id="lbl_Linemanager" style="color:#5960ff; font-weight: 900; text-decoration: underline;"><b>Irfan Ahmed Khan</b></span></h2>
                      <h2 class="lead text-right p-0 m-0" runat="server" id="H1"><b>HOD : </b>  <span runat="server" id="lbl_HodName" style="color:#5960ff; font-weight: 900; text-decoration: underline;"><b>Irfan Ahmed Khan</b></span></h2>
